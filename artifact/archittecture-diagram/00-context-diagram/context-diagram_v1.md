...
```mermaid
flowchart LR
    SRS["🌐 State Regulation Sources <br>27 states<br>CA · NY · IL · NJ · MN · ..."]
    ...
    SRS   -->|"① auto-fetch regulations<br>weekly cron · ≤1 week latency"| LX
    LX    -->|"② pending review<br>webhook"| CT
    CT    -->|"③ approve / reject<br>Action API"| LX
    IRA   -->|"④ employer profile push<br>Push API · UUID + metrics · no PII"| LX
...
| --- | --- | --- |
| **State Regulation Sources** | External System | State government websites and PDFs. Initially CA, NY, IL, NJ, MN (5 states); expands to 27. |
...
| --- | --- | --- | --- | --- |
| ① | Regulatory auto-fetch | LX → State Sources | HTTP/PDF scrape | Weekly cron |
...
| ④ | Employer profile push | IRALOGIX → LX | REST Push API (POST) | New employer or data change |
...
4. **Regulation detection latency** — Logixian guarantees ≤ 1-week latency for detecting changes in state regulation sources.
...
- [MSE IRALOGIX Project Description](../../../client-meeting/2026-01-26/MSE%20IRALOGIX%20Project%20Description.md) — Project scope, milestone definitions, and component overview
- [Architecture Driver](../../architecture-driver/requirement_v1.md)
